...
namespace Turnstile.Tests.TagHelpers
{
    ...
    public class TurnstileTagHelperTests
    {
        ...
        public void Construction_IsSuccessful()
        {
            ...
            // Act
            var instance = new TurnstileTagHelper(_settingsMock.Object, _optionsMock.Object);
        ...
        public void Constructor_ShouldThrow_WhenSettingsNull()
        {
            ...
            // Assert
            Assert.Throws<ArgumentNullException>(() => new TurnstileTagHelper(null, _optionsMock.Object));
        }
        ...
        public void Constructor_ShouldThrow_WhenOptionsNull()
        {
            ...
            // Assert
            Assert.Throws<ArgumentNullException>(() => new TurnstileTagHelper(_settingsMock.Object, null));
        }
        ...
        public void Constructor_ShouldSet_DefaultValues_FromGlobalOptions()
        {
            ...
            // Act
            var tagHelper = new TurnstileTagHelper(_settingsMock.Object, _optionsMock.Object);
        ...
        {
            // Arrange
            var scriptTagHelper = new TurnstileTagHelper(_settingsMock.Object, _optionsMock.Object);
