...
{
    [TestFixture]
    public class TurnstileV3TagHelperTests
    {
        ...
        public void Construction_IsSuccessful()
        {
            ...
            // Act
            var instance = new TurnstileV3TagHelper(_settingsMock.Object, _tagHelperComponentManagerMock.Object);
        ...
        public void Constructor_ShouldThrow_WhenSettingsNull()
        {
            ...
            // Assert
            Assert.Throws<ArgumentNullException>(() => new TurnstileV3TagHelper(null, _tagHelperComponentManagerMock.Object));
        }
        ...
        public void Constructor_ShouldThrow_WhenTagHelperComponentManagerNull()
        {
            ...
            // Assert
            Assert.Throws<ArgumentNullException>(() => new TurnstileV3TagHelper(_settingsMock.Object, null));
        }
        ...
        {
            // Arrange
            var scriptTagHelper = new TurnstileV3TagHelper(_settingsMock.Object, _tagHelperComponentManagerMock.Object);
        ...
        {
            // Arrange
            var nullCallbackTagHelper = new TurnstileV3TagHelper(_settingsMock.Object, _tagHelperComponentManagerMock.Object)
            {
                Callback = null,
                FormId = null
            };
            var emptyCallbackTagHelper = new TurnstileV3TagHelper(_settingsMock.Object, _tagHelperComponentManagerMock.Object)
            {
        ...
        public void Process_ShouldSet_CallbackToDefaultCallback_WhenCallbackIsNullOrEmpty()
        {
            // Arrange
            var formId = $"formId";
            var tag = new TurnstileV3TagHelper(_settingsMock.Object, _tagHelperComponentManagerMock.Object)
            {
                Callback = null,
                FormId = formId,
                Action = "submit"
        ...
        {
            // Arrange
            var tagHelper = new TurnstileV3TagHelper(_settingsMock.Object, _tagHelperComponentManagerMock.Object)
            {
                Callback = "submit",
                Action = "submit"
            };
