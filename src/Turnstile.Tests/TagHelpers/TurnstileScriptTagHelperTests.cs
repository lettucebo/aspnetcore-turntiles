...
{
    [TestFixture]
    public class TurnstileScriptTagHelperTests
    {
        ...
        public void Construction_IsSuccessful()
        {
            ...
            // Act
            var instance = new TurnstileScriptTagHelper(_settingsMock.Object);
        ...
        public void Constructor_ShouldThrow_WhenSettingsNull()
        {
            ...
            // Assert
            Assert.Throws<ArgumentNullException>(() => new TurnstileScriptTagHelper(null));
        }
        ...
        {
            // Arrange
            var scriptTagHelper = new TurnstileScriptTagHelper(_settingsMock.Object);
        ...
        public void Process_ShouldAdd_SrcAttribute()
        {
            ...
            Assert.AreEqual(TurnstileScriptTagHelper.RecaptchaScriptEndpoint, _tagHelperOutput.Attributes["src"].Value);
        }
