...
using AspNetCore.Turnstile.Core.Localization;
using Microsoft.AspNetCore.Mvc.Filters;

namespace AspNetCore.Turnstile.Core
{
    /// <summary>
    ...
    public sealed class ValidateTurnstileAttribute : Attribute, IFilterFactory, IOrderedFilter
    {
        /// <inheritdoc />
...
#pragma warning disable CA1062 // Validate arguments of public methods
            var filter = serviceProvider.GetService(typeof(IValidateTurnstileFilter)) as IValidateTurnstileFilter;
