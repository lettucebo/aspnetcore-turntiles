...
namespace AspNetCore.Turnstile.Core.TagHelpers
{
    ...
    public class TurnstileTagHelper : TagHelper
    {
        ...
        public TurnstileTagHelper(IOptionsMonitor<TurnstileSettings> settings, IOptionsMonitor<TurnstileOptions> options)
        {
        ...
        /// </summary>
        /// <remarks>
        /// The invisible theme is not a option, because you should use <see cref="TurnstileInvisibleTagHelper"/> instead for that.
        /// </remarks>
