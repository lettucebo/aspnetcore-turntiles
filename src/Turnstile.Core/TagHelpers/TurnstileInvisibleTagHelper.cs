...
namespace AspNetCore.Turnstile.Core.TagHelpers
{
    ...
    public class TurnstileInvisibleTagHelper : TagHelper
    {
        ...
        public TurnstileInvisibleTagHelper(IOptionsMonitor<TurnstileSettings> settings, IOptionsMonitor<TurnstileOptions> options,
