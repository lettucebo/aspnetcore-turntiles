...
namespace AspNetCore.Turnstile.Core.TagHelpers
{
    ...
    public class TurnstileV3TagHelper : TagHelper
    {
        ...
        public TurnstileV3TagHelper(IOptionsMonitor<TurnstileSettings> settings, ITagHelperComponentManager tagHelperComponentManager)
        {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            // todo: fix issue with class not being added
